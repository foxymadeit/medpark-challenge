...
| # | Rule | Evidence |
|---|---|---|
| W1 | **Reported speech, past tense, impersonal. No quotes, no speaker names in sentences.** English: "The Board was informed that …", "A cardiac MRI was proposed." Romanian: "Consiliul a fost informat că …", "S-a propus …". Russian: "Совет проинформирован, что …", "Предложено …". People appear only in the attendance list and as action owners. This is stricter than the corpus, which often names the speaker ("Dl X a menționat", "выступил X"); the Medpark brief asks for content only, and a recording with no spoken names cannot support the attribution anyway. | All 41 documents use reported speech and none quotes speech; impersonal form at the team's request (2026-09-26) |
...
| W3 | **People: name plus role, in the local format.** English: "Full Name, Role (INITIALS)". Moldova: "dl / dna Nume, funcția"; chair as "Prenume NUME – funcția, președinte al ședinței". Russian: "Фамилия И.О. - должность"; Latin-script names stay in Latin script in the Russian document, since that is how they are written in Moldova. | `en_uhs_pack_2025-11`, `md_gov_pv73_2025-12`, `ru_tula_dkb_obshsovet_2023-05` |
