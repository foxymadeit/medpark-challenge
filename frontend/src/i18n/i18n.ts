...
const resources = {
  en: {
    translation: {
      ...
      auditIntro: "Who did what and when. Content is never recorded, and entries cannot be changed or deleted.",
      auditWhen: "When",
      auditWho: "Who",
      auditWhat: "What",
      auditResult: "Result",
      auditNobody: "Not signed in",
      auditDone: "Done",
      auditRefused: "Refused",
      auditEmpty: "Nothing recorded yet.",
      audit_upload: "Uploaded a recording",
      audit_recording: "Saved a recording",
      audit_listen: "Played a recording",
      audit_process: "Started the minutes",
      audit_send: "Sent the minutes",
      audit_stop: "Stopped sending",
      audit_confirm: "Settled a flagged item",
      audit_document: "Opened a document",
      audit_transcript: "Read a transcript",
      audit_edit: "Edited the minutes",
      audit_login: "Signed in",
      audit_logout: "Signed out",
      ...
      correctedApprove: "Approve",
      correctedAdding: "Adding…",
      correctedAdded: "Added to the glossary",
      correctedEmpty: "No corrections yet.",
      ...
      waitingParticipants: "Waiting for review: add at least one participant.",
      waitingOwners: "Waiting for review: give every task an owner.",
      waitingFlags: "Waiting for review: keep or take out the flagged items.",
      waitingCheck: "Check the minutes, then send.",
      ...
      routingTo: "Sends to the {{list}}",
      routingToCount_one: "Sends to the {{list}}, {{count}} recipient",
      routingToCount_other: "Sends to the {{list}}, {{count}} recipients",
      reason_noOwner: "No owner was named in the meeting.",
      reason_ownerNotHeard: "The owner was not named where this was said.",
      reason_deadline: "The deadline was not clear.",
      reason_number: "A number is not in the transcript.",
      reason_quote: "The quote could not be found in the transcript.",
      reason_name: "A name does not appear in the transcript.",
      reason_notAgreed: "Nobody agreed to it in the meeting.",
      settled: "Settled",
      takenOut: "Taken out",
      continueToSending: "Continue to sending",
      sendingWaits:
        "Sending to the {{list}} waits until every item is settled.",
      documents: "Documents",
  ...
  ro: {
    translation: {
      ...
      auditIntro: "Cine a făcut ce și când. Conținutul nu este înregistrat niciodată, iar intrările nu pot fi modificate sau șterse.",
      auditWhen: "Când",
      auditWho: "Cine",
      auditWhat: "Ce",
      auditResult: "Rezultat",
      auditNobody: "Neautentificat",
      auditDone: "Efectuat",
      auditRefused: "Refuzat",
      auditEmpty: "Nimic înregistrat încă.",
      audit_upload: "A încărcat o înregistrare",
      audit_recording: "A salvat o înregistrare",
      audit_listen: "A ascultat o înregistrare",
      audit_process: "A pornit procesul-verbal",
      audit_send: "A trimis procesul-verbal",
      audit_stop: "A oprit trimiterea",
      audit_confirm: "A decis un punct semnalat",
      audit_document: "A deschis un document",
      audit_transcript: "A citit o transcriere",
      audit_edit: "A editat procesul-verbal",
      audit_login: "S-a autentificat",
      audit_logout: "S-a deconectat",
      ...
      correctedLanguage: "Limba",
      correctedApprove: "Aprobă",
      correctedAdding: "Se adaugă…",
      correctedAdded: "Adăugat în glosar",
      correctedEmpty: "Nicio corectură încă.",
      ...
      routingTo: "Se trimite către {{list}}",
      routingToCount_one: "Se trimite către {{list}}, {{count}} destinatar",
      routingToCount_few: "Se trimite către {{list}}, {{count}} destinatari",
      routingToCount_other:
        "Se trimite către {{list}}, {{count}} de destinatari",
      reason_noOwner: "În ședință nu a fost numit un responsabil.",
      reason_ownerNotHeard:
        "Responsabilul nu a fost numit acolo unde s-a spus asta.",
      reason_deadline: "Termenul nu a fost clar.",
      reason_number: "Un număr nu apare în transcriere.",
      reason_quote: "Citatul nu a fost găsit în transcriere.",
      reason_name: "Un nume nu apare în transcriere.",
      reason_notAgreed: "Nimeni nu a fost de acord în ședință.",
      settled: "Rezolvat",
      takenOut: "Scos",
  ...
  ru: {
    translation: {
      ...
      auditIntro: "Кто, что и когда сделал. Содержимое никогда не записывается, а записи нельзя изменить или удалить.",
      auditWhen: "Когда",
      auditWho: "Кто",
      auditWhat: "Что",
      auditResult: "Результат",
      auditNobody: "Без входа",
      auditDone: "Выполнено",
      auditRefused: "Отказано",
      auditEmpty: "Пока ничего не записано.",
      audit_upload: "Загрузил запись",
      audit_recording: "Сохранил запись",
      audit_listen: "Прослушал запись",
      audit_process: "Запустил протокол",
      audit_send: "Отправил протокол",
      audit_stop: "Остановил отправку",
      audit_confirm: "Решил отмеченный пункт",
      audit_document: "Открыл документ",
      audit_transcript: "Прочитал расшифровку",
      ...
      correctedLanguage: "Язык",
      correctedApprove: "Одобрить",
      correctedAdding: "Добавляется…",
      correctedAdded: "Добавлено в глоссарий",
      correctedEmpty: "Исправлений пока нет.",
      ...
      routingTo: "Отправка: {{list}}",
      routingToCount_one: "Отправка: {{list}}, {{count}} получатель",
      routingToCount_few: "Отправка: {{list}}, {{count}} получателя",
      routingToCount_many: "Отправка: {{list}}, {{count}} получателей",
      routingToCount_other: "Отправка: {{list}}, {{count}} получателя",
      reason_noOwner: "На заседании не назвали ответственного.",
      reason_ownerNotHeard:
        "Ответственного не назвали там, где это прозвучало.",
      reason_deadline: "Срок был назван неясно.",
      reason_number: "Числа нет в стенограмме.",
      reason_quote: "Цитата не найдена в стенограмме.",
      reason_name: "Имени нет в стенограмме.",
      reason_notAgreed: "На заседании с этим никто не согласился.",
      settled: "Решено",
      takenOut: "Убрано",
